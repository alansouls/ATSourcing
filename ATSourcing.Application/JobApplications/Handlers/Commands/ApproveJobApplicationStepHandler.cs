...
internal class ApproveJobApplicationStepHandler : IRequestHandler<ApproveJobApplicationStepCommand, Result>
{
    private readonly IJobApplicationRepository _jobApplicationRepository;
    private readonly IJobRepository _jobRepository;
    private readonly TimeProvider _timeProvider;

    public ApproveJobApplicationStepHandler(IJobApplicationRepository jobApplicationRepository, IJobRepository jobRepository, TimeProvider timeProvider)
    {
    ...
    public async Task<Result> Handle(ApproveJobApplicationStepCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = jobApplication.ApproveCurrentStep(nextStep?.CreateStep(), request.FinalObservation, _timeProvider.GetUtcNow());
